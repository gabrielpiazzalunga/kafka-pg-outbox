...
/// </summary>
internal sealed class LoadTestHandler(LoadTestConsumeTracker tracker) : IMessageHandler<MBESReading>
{
    public Task HandleAsync(string? key, MBESReading message, string topic,
