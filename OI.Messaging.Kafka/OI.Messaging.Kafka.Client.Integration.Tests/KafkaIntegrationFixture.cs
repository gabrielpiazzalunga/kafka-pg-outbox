...
using OI.Messaging.Kafka.Client.Integration.Tests.SchemaRegistry;
        ...
        where THandler : class, IMessageHandler<TestEvent>
    {
        ...
        return new HostBuilder()
            .ConfigureServices(services =>
            {
                ...
                services.AddOIKafkaProducer(connection, producerConfig, resilience);
                services.AddOIKafkaConsumer<TestEvent, THandler>(connection, consumerConfig);
            })
            .Build();
    }
